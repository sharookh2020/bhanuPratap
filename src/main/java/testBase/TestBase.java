...
public class TestBase {
	...
	public String[][] getExcelData(String excelName, String sheetName) {
		String excellocation = ResourceHelper.getResourcePath("/src/test/resources/testData/") + excelName;
	...
	/**
	 * This method will give excel data in 2D array based on sheet Name (*****Overloaded Method*****)
	 * 
	 * @param excellocation
	 * @param sheetName
	 * @return
	...
	public String getScreenShot(String imageName) throws IOException {
		...
		String imagelocation = ResourceHelper.getBaseResourcePath() + "/src/test/resources/screenshot/";
